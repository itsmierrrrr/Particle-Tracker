...
function App() {
  ...
  const [palettes, setPalettes] = useState({ Brain: { main: '#ffa500', pulse: '#ffff00' }, DNA: { strandOne: '#00ffff', strandTwo: '#ff00ff', connector: '#ffffff' }, Saturn: { planet: '#ffaa00', ring: '#00ffff' }, Galaxy: { core: '#ffffff', outer: '#6633ff' }, Earth: { ocean: '#008cff', land: '#32cd32', atmosphere: '#bfefff' }, Flower: { main: '#ff3b7a', pulse: '#4fd66b' }, Balloons: { balloonOne: '#ff4f81', balloonTwo: '#39c6ff', balloonThree: '#ffd447', string: '#f7d154' } })
